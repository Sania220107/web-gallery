...
const CommentsPage = () => {
  ...
  useEffect(() => {
    if (photoId) {
      fetch(`https://gallerydb-production.up.railway.app/komentar/foto/${photoId}`, {
        method: "GET",
        headers: {
  ...
  const handleAddComment = () => {
    ...
    fetch("https://gallerydb-production.up.railway.app/komentar/", {
      method: "POST",
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <img
          src={`https://gallerydb-production.up.railway.app/uploads/${photoId}.jpg`} // URL now includes dynamic photoId
          alt="Designer Work"
